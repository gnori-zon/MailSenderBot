...
public class AfterChangeMailCommand implements Command {
    ...
    public AfterChangeMailCommand(ModifyDataBaseService modifyDataBaseService, SendBotMessageService sendBotMessageService, MessageTypesDistributorService messageTypesDistributorService) {
    ...
    public void execute(Update update) {
        ...
        //TODO added try{}, if mail already exist
