...
import static org.gnori.client.telegram.service.command.utils.preparers.TextPreparer.prepareTextForBeforeChangeSentDateMessage;
...
public class ChangeMessageItemSentDateCallbackCommand implements CallbackCommand {
    ...
    public CallbackCommandType getSupportedType() {
        return CallbackCommandType.CHANGE_MESSAGE_ITEM_SENT_DATE;
    }
}
