...
import static org.gnori.client.telegram.service.command.utils.preparers.TextPreparer.prepareTextForBeforeChangeKeyForMailMessage;
...
public class ChangeKeyCallbackCommand implements CallbackCommand {
    ...
    public void execute(Account account, Update update) {
        ...
        accountService.updateStateById(account.getId(), State.KEY_FOR_MAIL_PENDING);
