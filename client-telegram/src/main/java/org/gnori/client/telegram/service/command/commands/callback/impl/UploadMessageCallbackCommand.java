...
import static org.gnori.client.telegram.service.command.utils.preparers.TextPreparer.prepareTextForBeforeDownloadMessage;
...
public class UploadMessageCallbackCommand implements CallbackCommand {
    ...
    public void execute(Account account, Update update) {
        ...
        accountService.updateStateById(account.getId(), State.UPLOAD_MESSAGE_PENDING);
