...
import static org.gnori.client.telegram.service.command.utils.preparers.TextPreparer.prepareTextForBeforeChangeContentMessage;
...
public class ChangeMessageItemTextCallbackCommand implements CallbackCommand {
    ...
    public void execute(Account account, Update update) {
        ...
        accountService.updateStateById(account.getId(), State.MESSAGE_TEXT_PENDING);
