...
import static org.gnori.client.telegram.service.command.utils.preparers.TextPreparer.prepareTextForBeforeChangeAnnexMessage;

@Component
@RequiredArgsConstructor
public class ChangeMessageItemAnnexCallbackCommand implements CallbackCommand {
    ...
    public void execute(Account account, Update update) {
        ...
        accountService.updateStateById(account.getId(), State.MESSAGE_ANNEX_PENDING);
    ...
    public CallbackCommandType getSupportedType() {
        return CallbackCommandType.CHANGE_MESSAGE_ITEM_ANNEX;
    }
}
